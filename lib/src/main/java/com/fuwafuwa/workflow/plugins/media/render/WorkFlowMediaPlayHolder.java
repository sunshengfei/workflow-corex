package com.fuwafuwa.workflow.plugins.media.render;//package com.fuwafuwa.workflows.workflow.adapter;
//
...
import com.fuwafuwa.workflow.plugins.media.template.MediaTemplateDelegate;
 ...
 */
public class WorkFlowMediaPlayHolder extends BaseFlowRecyclerViewHolder<IWorkFlowAdapterItem> {
    ...
    public WorkFlowMediaPlayHolder(ViewGroup parent) {
        ...
        cmdIcon.setImageResource(R.drawable.media);
    }
    ...
    public void update(IWorkFlowAdapterItem data) {
        ...
        String template = MediaTemplateDelegate.getTemplate(RegexHelper.isEmptyElse(input, "输入"));
