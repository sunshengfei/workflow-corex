package com.fuwafuwa.workflow.plugins.loop.render;//package com.fuwafuwa.workflows.workflow.adapter;
//
 ...
 */
public class WorkFlowLoopCmdHolder extends BaseFlowRecyclerViewHolder<IWorkFlowAdapterItem> {
    ...
    public WorkFlowLoopCmdHolder(ViewGroup parent) {
    ...
    public void update(IWorkFlowAdapterItem data) {
        ...
        cmdType.setText("条件");
        String condition = count + "次";
        String template = ConditionTemplateDelegate.getLoopTemplate(condition);
