...
public class ElipseDrawable extends Drawable {
    ...
    public ElipseDrawable(Bitmap bitmap) {
    ...
    public static ElipseDrawable fromBitmap(Bitmap bitmap) {
        if (bitmap != null) {
            return new ElipseDrawable(bitmap);
        } else {
            return null;
        }
    }
    ...
    public static Drawable fromDrawable(Drawable drawable) {
        if (drawable != null) {
            if (drawable instanceof ElipseDrawable) {
                ...
                // loop through layers to and change to ElipseDrawables if
                // possible
                for (int i = 0; i < num; i++) {
    ...
    public ElipseDrawable setCornerRadius(float radius) {
    ...
    public ElipseDrawable setBorderWidth(int width) {
        mBorderWidth = width;
        mBorderPaint.setStrokeWidth(mBorderWidth);
        return this;
    }
    ...
    public ElipseDrawable setBorderColor(int color) {
    ...
    public ElipseDrawable setBorderColors(ColorStateList colors) {
    ...
    public ElipseDrawable setOval(boolean oval) {
        mOval = oval;
        return this;
    }
    ...
    public ElipseDrawable setScaleType(ScaleType scaleType) {
        if (scaleType == null) {
